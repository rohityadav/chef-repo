...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ry2339646-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/softech"
  #   chef.validation_client_name = "softech-validator"
  #   chef.validation_key_path = ".chef/softech-validator.pem"
  # end
end
